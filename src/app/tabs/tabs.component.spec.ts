...
describe('Tabs Component', () => {
  ...
  it('should navigate to correct routes when tabs are clicked', async () => {
    ...
    const tripTab = tabButtons.find((tab: { nativeElement: { getAttribute: (arg0: string) => string; }; }) => tab.nativeElement.getAttribute('tab') === 'trip');
    ...
    await harness.navigateByUrl('/trip');
